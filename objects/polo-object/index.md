...
layout: base
header-image: images/polo-banner.jpg
thumbnail: images/Polo.jpg
...
{% include images/figure.html class="right" width="45%" caption="Siyavush Plays Polo before Afrasiyab from the *Shahnama*, showing mounted players competing in an organized polo match. [Source](https://www.metmuseum.org/art/collection/search/452135)" image-path="images/Polo.jpg" %} 
...
{% include images/figure.html class="right" width="40%" caption="A Persian manuscript scene showing mounted players in a polo match, showing how the sport often appeared in elite visual culture. [Source](https://art.thewalters.org/object/W.638.131B/)" image-path="images/second-polo-image.jpg" %}
